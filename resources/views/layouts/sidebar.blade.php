<aside class="w-64 bg-school-primary text-white flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        ...
        <a href="{{ route('guardians.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('guardians.*') ? 'bg-school-secondary text-white' : 'text-school-light hover:bg-school-secondary' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @endif
        @if(auth()->user()->role === 'admin' || auth()->user()->role === 'secretaria')
        <a href="{{ route('services.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('services.*') ? 'bg-school-secondary text-white' : 'text-school-light hover:bg-school-secondary' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"/>
            </svg>
            <span>Serviços</span>
